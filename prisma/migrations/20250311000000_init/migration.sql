...
-- CreateIndex
CREATE UNIQUE INDEX "Read_userId_articleId_key" ON "Read"("userId", "articleId");
...
-- AddForeignKey
ALTER TABLE "Read" ADD CONSTRAINT "Read_articleId_fkey" FOREIGN KEY ("articleId") REFERENCES "Article"("id") ON DELETE CASCADE ON UPDATE CASCADE;
