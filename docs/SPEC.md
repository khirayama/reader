...
### ナビゲーション
- **Web**: ドロワー（サイドバー）レイアウト
  - デスクトップ: 常時表示のサイドバー（320px幅）
  - モバイル: ハンバーガーメニューで開閉するドロワー
- **Native**: ドロワーナビゲーション
  - タブレット: 常時表示のサイドバー（320px幅）
  - スマートフォン: スワイプまたはメニューボタンで開閉するドロワー
  - iPad対応: マスター/ディテール表示（記事一覧と記事詳細の同時表示）
...
- **ブレークポイント**:
  ...
  - タブレット/デスクトップ: >= 768px
- **タブレット最適化**:
  - Nativeアプリ: iPadなどの大画面デバイスで最適なレイアウト
  - 記事一覧: 左側に400px幅の固定サイドバー
  - 記事詳細: 右側の残りスペースで記事内容を表示
