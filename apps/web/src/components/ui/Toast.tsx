...
function ToastItem({ toast, onRemove }: ToastItemProps) {
  ...
  return (
    <div className={`flex items-start p-4 border rounded-lg shadow-lg transition-all duration-300 ${getToastStyles()}`}>
      ...
      <button
        type="button"
        className="ml-4 inline-flex text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded"
